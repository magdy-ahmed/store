...
<div className="header-info">
							<div class="box-account-lc box">
								<a href="" class="link-user-top"><img src="./packages/images/home_1/icon-user.png" alt="" /></a>
								<div class="box-inner">
									<ul class="links">
									...
									<div class="block block-language">
										...
										<ul>
											<li>
												...
												<img src="./packages/images/flags/flag-default.jpg" alt="flag"/>
												<span>English</span>
												</a>
											</li>
											<li>
												<a href="">                    
												<img src="./packages/images/flags/flag-french.jpg" alt="flag"/>
												<span>French</span>
												</a>
											</li>
											<li>
												<a href="">                    
												<img src="./packages/images/flags/flag-german.jpg" alt="flag"/>
												<span>German</span>
												</a>
											</li>
											<li>
												<a href="">                    
												<img src="./packages/images/flags/flag-brazil.jpg" alt="flag"/>
												<span>Brazil</span>
												</a>
											</li>
										</ul>
							...
							<div class="block-cart box">
								<a href="#" class="link-cart-top">
									<img src="./packages/images/home_1/icon-cart.png" alt="" />
									...
									<div class="inner">
										...
										<ol id="cart-sidebar" class="mini-products-list">
											<li class="item odd">
												...
												<img width="70" height="84" src="./packages/images/home_1/img-cart.gif" alt=""/>
												</a>
